        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <br>
                    <tr>
                        <a href="index.php" class="btn btn-primary">1st Semester</a>
                        <a href="2nd_sem.php" class="btn btn-primary">2nd Semester</a>
                        <a href="3rd_sem.php" class="btn-lg btn-success">3rd Semester</a>
                    </tr>
                    <?php
                    // Include config file
                    ...
                    $sql = "SELECT * FROM result WHERE Student_ID = '" .$_SESSION['Student_ID']. "' and Result_Sem = 3";
