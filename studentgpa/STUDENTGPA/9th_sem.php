            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <tr>
                        ...
                        <a style="background-color:silver; color:white" href="9th_sem.php" class="btn">9th Sem</a>
                    </tr>
                    <br>
                    <br>
                    <?php
                    ...
                    $sql = "SELECT * FROM result WHERE Student_ID = '" .$_SESSION['Student_ID']. "' and Result_Sem = 9";
