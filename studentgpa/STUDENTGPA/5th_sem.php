            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <tr>
                        ...
                        <a style="background-color:silver; color:white" href="5th_sem.php" class="btn">5th Sem</a>
                        <a style="background-color:gray; color:white" href="6th_sem.php" class="btn">6th Sem</a>
                        <a style="background-color:gray; color:white" href="7th_sem.php" class="btn">7th Sem</a>
                    ...
                    $sql = "SELECT * FROM result WHERE Student_ID = '" .$_SESSION['Student_ID']. "' and Result_Sem = 5";
