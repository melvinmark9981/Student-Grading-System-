            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <tr>
                        ...
                        <a style="background-color:silver; color:white" href="4th_sem.php" class="btn">4th Sem</a>
                    ...
                    $sql = "SELECT * FROM result WHERE Student_ID = '" .$_SESSION['Student_ID']. "' and Result_Sem = 4";
